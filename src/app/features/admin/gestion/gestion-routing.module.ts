...
const routes: Routes = [
  ...
  { path: 'usuarios/editar/:id', component: UsuarioFormComponent, canActivate: [UsuarioIdRedirectGuard] },
  ...
  { path: 'privilegios/editar/:id', component: PrivilegioFormComponent, canActivate: [PrivilegioIdRedirectGuard] },
  { path: 'privilegios/eliminar/codigo/:codigo', component: EliminarPrivilegioComponent },
  { path: 'privilegios/eliminar/:id', component: EliminarPrivilegioComponent, canActivate: [PrivilegioIdRedirectGuard] },
  { path: 'roles/eliminar/codigo/:codigo', component: EliminarRolComponent },
  { path: 'roles/eliminar/:id', component: EliminarRolComponent, canActivate: [RolIdRedirectGuard] },
