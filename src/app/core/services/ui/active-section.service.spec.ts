...
import { ActiveSectionService, ActiveSectionState, MenuExpansionState } from './active-section.service';
...
describe('ActiveSectionService', () => {
  ...
  beforeEach(() => {
    routerEventsSubject = new BehaviorSubject(new NavigationEnd(1, '/admin/dashboard', '/admin/dashboard'));
  ...
  describe('Item and Section Status', () => {
    ...
    it('should correctly identify active sections', () => {
      ...
      const contentSection = mockNavigationItems.find(item => item.name === 'Gestión de Contenido')!;
  ...
  describe('Property 6: Active section highlighting', () => {
    ...
    it('should consistently highlight active section across different routes', () => {
      const testRoutes = [
        { url: '/admin/dashboard', expectedSection: null, expectedItem: '-admin-dashboard' },
        { url: '/admin/control/entradas', expectedSection: 'gestion-de-contenido', expectedItem: '-admin-control-entradas' },
        { url: '/admin/control/entradas/crear', expectedSection: 'gestion-de-contenido', expectedItem: '-admin-control-entradas-crear' },
        { url: '/admin/control/comentarios', expectedSection: 'gestion-de-contenido', expectedItem: '-admin-control-comentarios' },
        { url: '/admin/control/gestion/usuarios', expectedSection: 'administracion', expectedItem: '-admin-control-gestion-usuarios' }
      ];
